...
Hands-on tech leader and repeat founder with 20+ years turning code into products. Co-founded Plataformatec (acquired by Nubank), where we created the Elixir programming language. Currently building infrastructure for agentic commerce at New Generation.
...
- [hnswlib](https://github.com/elixir-nx/hnswlib) - Elixir binding for the hnswlib library
...
- [tribunal](https://github.com/georgeguimaraes/tribunal) - Elixir library
- [claude-code-graphite](https://github.com/georgeguimaraes/claude-code-graphite) - Claude Code plugins for Graphite stacked PRs
- [arcana-adept](https://github.com/georgeguimaraes/arcana-adept) - Example Phoenix app demonstrating Arcana
